...
import { LocalLineItem, LocalProduct } from '../../offline/db';
...
export const LineItemEditor: React.FC<LineItemEditorProps> = ({
  ...
  const handleAddLine = () => {
    ...
    const newLine: LocalLineItem = defaultProduct
      ? {
    ...
    <div style={{ marginBottom: 20 }}>
      ...
      >
        <div>
          Sous-total HT :{' '}
          <strong>
            {totalUntaxed.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })}
          </strong>
        </div>
        <div>
          Total TVA :{' '}
